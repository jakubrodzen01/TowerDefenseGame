...
import enemies.Kapela;
import enemies.Enemy;
import enemies.Biedron;
import enemies.Urban;
import enemies.Stasko;
...
public class EnemyManager {
	...
	private void loadEnemyImgs() {
		BufferedImage atlas = LoadAndSave.getSpriteAtlas();
		for (int i = 0; i < 4; i++)
	...
	private void loadEffectImgs() {
		slowEffect = LoadAndSave.getSpriteAtlas().getSubimage(9 * 32, 2 * 32, 32, 32);
	}
	...
	public void addEnemy(int enemyType) {
		...
		switch (enemyType) {
			case URBAN:
				enemies.add(new Urban(x, y, 0, this));
				break;
			case KAPELA:
				enemies.add(new Kapela(x, y, 0, this));
				break;
			case BIEDRON:
				enemies.add(new Biedron(x, y, 0, this));
				break;
			case STASKO:
				enemies.add(new Stasko(x, y, 0, this));
				break;
		}
	...
	public int getNewBarWidth(Enemy e) {
